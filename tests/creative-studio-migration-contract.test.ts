...
const baseMigration = readFileSync(resolve(process.cwd(), "supabase/migrations/20260920164246_hosted_creative_studio.sql"), "utf8");
const catalogMigration = readFileSync(resolve(process.cwd(), "supabase/migrations/20260920225246_creative_studio_full_video_catalog.sql"), "utf8");
